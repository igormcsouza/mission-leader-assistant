...
from handlers.baptismal_plan_handler import BaptismalPlanHandler  # noqa: E402
...
class TestBaptismalPlanHandlerGetPlan(unittest.TestCase):
    ...
    def test_get_plan_returns_plan(self):
        ...
        handler.do_GET()
        self.assertEqual(handler._response_code, 200)
        self.assertEqual(handler._response_body["plan"]["id"], plan_id)
...
class TestBaptismalPlanHandlerUpdatePlan(unittest.TestCase):
    ...
    def test_update_plan_returns_ok(self):
        ...
        handler.do_PUT()
        self.assertEqual(handler._response_code, 200)
        self.assertEqual(handler._response_body["plan"]["status"], "Scheduled")
